...
footer{display:block}footer>.footer-copy{display:block}.update-cluster{display:inline-flex;align-items:center;gap:7px;max-width:100%;margin-top:9px;white-space:nowrap}.update-control{padding:5px 8px;font-size:11px;font-weight:700}.update-status{color:#b9d2f2;font-size:11px;transition:opacity .3s}.update-status a{color:inherit;font-weight:750;text-decoration:underline;text-underline-offset:2px}.update-status.changed{color:#edc36e}.update-status.error{color:#ff9ca5}.update-status[hidden]{display:none}
</style>
<script>
(() => {
